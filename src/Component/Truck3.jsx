...
// Main Truck3 component to manage form data and table
function Truck3() {
  ...
  const saveData = async (e) => {
    ...
    try {
      ...
      if (editMode) {
        const docRef = doc(db, "Truck3", formData.id);
        ...
        await addDoc(collection(db, "Truck3"), {
          date: formData.date,
          driverName: formData.driverName,
          jobs: formData.jobs,
        });
  ...
  const fetchData = async () => {
    try {
      ...
      const querySnapshot = await getDocs(collection(db, "Truck3"));
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await deleteDoc(doc(db, "Truck3", id));
      fetchData();
    } catch (error) {
